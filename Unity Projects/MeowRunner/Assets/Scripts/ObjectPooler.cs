	...
	public class ObjectPooler : MonoBehaviour
	{
		...
		public GameObject GetPooledObject(int index)
		{
			...
			if (itemsToPool[index].shouldExpand)
			{
				...
				GameObject obj = (GameObject)Instantiate(itemsToPool[index].objectToPool, itemsToPool[index].parentObject.transform);
				obj.SetActive(false);
		...
		void ObjectPoolItemToPooledObject(int index)
		{
			...
			{
				GameObject obj = (GameObject)Instantiate(item.objectToPool, item.parentObject.transform);
				obj.SetActive(false);
